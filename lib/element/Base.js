...
/**
 * The base Fresh element
 * Adds additional properties and methods to the lifecycle
 * methods defined by the Custom Elements API
 */
const FreshBase = {
  $$__typeof: TYPE,
  ...
  // This will cause problems in its current state, but I want to 
  // keep around since I'm sure it'll soon become valuable
  // 
...
/**
 * The Base element with methods defined by the Custom Elements API
 */
