...
export default class extends HTMLElement {
  constructor(args) {
    // customElementsLib.define({ target: new.target })
    super()
     ...
     *
     * If a string is passed it will be used as the selector for the template
     * If an object is passed in, assign it to the props property
     */
